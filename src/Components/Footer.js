            ...
            <div className="w-[57%] max-w-screen-xl mx-auto md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                        <li>
                            <a href="#" className="hover:text-black me-4 md:me-6">Home</a>
                        </li>
                        <li>
                            <a href="#" className="hover:text-black me-4 md:me-6">Services</a>
                        </li>
                        <li>
                            <a href="#" className="hover:text-black me-4 md:me-2">About</a>
                        </li>
                    </ul>
                </div>
            </div>
