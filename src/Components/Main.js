    ...
    <div className="bg-[#101010] w-full h-[500px]" id="main">
      <div className="flex flex-col lg:flex-row justify-center items-center h-full">
        <div className="left mx-auto md:mx-0 text-center lg:text-left flex flex-col pr-0 md:pr-4">
          <h1 className="text-white text-3xl md:text-5xl font-kumbh font-extrabold">Need an</h1><h1 className="text-white text-3xl md:text-5xl font-kumbh font-extrabold pb-2">Accountant</h1>
          <p className="text-white w-3/4 mx-auto md:w-[400px] text-[16px] md:text-md">SimpliTax Solutions would like to earn your business. We have over 30 years of experience in
